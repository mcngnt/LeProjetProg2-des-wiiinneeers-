...
@"_SM7__constG1-6" = private unnamed_addr constant { ptr, i32, i32, [25 x i16] } { ptr @"_SM35scala.scalanative.runtime.CharArrayG4type", i32 25, i32 2, [25 x i16] [ i16 115, i16 99, i16 97, i16 108, i16 97, i16 46, i16 100, i16 101, i16 114, i16 105, i16 118, i16 105, i16 110, i16 103, i16 46, i16 77, i16 105, i16 114, i16 114, i16 111, i16 114, i16 36, i16 83, i16 117, i16 109 ] }
@"_SM7__constG1-7" = private unnamed_addr constant { ptr, ptr, i32, i32, i32 } { ptr @"_SM16java.lang.StringG4type", ptr @"_SM7__constG1-6", i32 0, i32 25, i32 -1328446136 }
...
@"_SM21scala.deriving.MirrorG4type" = hidden global { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -59, i32 -1, ptr @"_SM7__constG1-1" }
@"_SM29scala.deriving.Mirror$ProductG4type" = hidden global { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -116, i32 -1, ptr @"_SM7__constG1-3" }
@"_SM31scala.deriving.Mirror$SingletonG4type" = hidden global { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -130, i32 -1, ptr @"_SM7__constG1-5" }
@"_SM25scala.deriving.Mirror$SumG4type" = hidden global { ptr, i32, i32, ptr } { ptr @"_SM15java.lang.ClassG4type", i32 -85, i32 -1, ptr @"_SM7__constG1-7" }